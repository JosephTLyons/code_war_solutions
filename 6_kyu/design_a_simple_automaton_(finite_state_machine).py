# Create a finite automaton that has three states. Finite automatons are the same as finite state
# machines for our purposes.

# Our simple automaton, accepts the language of A, defined as {0, 1} and should have three states:
# q1, q2, and q3. Here is the description of the states:
...
# You will have to design your state objects, and how your Automaton handles transitions. Also make
# sure you set up the three states, q1, q2, and q3 for the myAutomaton instance. The test fixtures
...
# represented as a string, because the language an automaton can accept isn't confined to just
# numbers. An automaton should be able to accept any 'symbol.'
