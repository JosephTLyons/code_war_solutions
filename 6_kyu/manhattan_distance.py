# The distance formula can be used to find the distance between two points. What if we were trying
# to walk from point A to point B, but there were buildings in the way? We would need some other
# formula..but which?

# Manhattan Distance

# Manhattan distance is the distance between two points in a grid (like the grid-like street
# geography of the New York borough of Manhattan) calculated by only taking a vertical and/or
# horizontal path.

# Complete the function that accepts two points and returns the Manhattan Distance between the two
# points.
