# Write a function that takes a string of braces, and determines if the order of the braces is
...
def validBraces(string):
    ...
    for character in string:
        if character in opening_braces:
            ...
            if len(stack) > 0:
                index = closing_braces.index(character)

                if stack.pop() != opening_braces[index]:
                    return False
