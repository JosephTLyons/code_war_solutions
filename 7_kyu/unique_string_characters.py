...
def solve(a, b):
    character_in_a_not_b = [character for character in a if character not in b]
    character_in_b_not_a = [character for character in b if character not in a]

    return "".join(character_in_a_not_b + character_in_b_not_a)
